...
function Footer() {
  return (
    <footer className="text-center lg:text-left bg-red-50 text-gray-600">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        ...
        <div className="flex justify-center">
          ...
          <a href="https://www.panaverse.co" className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href="https://www.github.com/panaverse" className="text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <Link href="/courses" className="text-gray-600">
                Courses
              </Link>
            </p>
            <p className="mb-4">
      ...
      <div className="text-center p-6 bg-red-100">
